  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? "bg-white/80 backdrop-blur-sm shadow-xs" : "bg-transparent"
      }`}
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                className="bg-white text-black hover:bg-gray-50 transition-all duration-300"
                variant="default"
              >
                Get Started
              </Button>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                className="border shadow-lg border-gray-900  transition-all duration-300"
                variant="default"
              >
                Login
              </Button>
