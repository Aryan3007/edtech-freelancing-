...
const courses = [
  {
    ...
    instructor: {
      name: "Jonathan Hope",
      avatar: "https://images.unsplash.com/photo-1599054802207-91d346adc120?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      location: "Yogyakarta",
    },
  },
  {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              <h1 className="lg:text-7xl text-4xl leading-tight">Let&apos;s Learn How to Surf</h1>
              <p className="text-gray-400 max-w-md">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque, at vel? Dolor repellendus quos voluptates asperiores velit voluptas temporibus, qui dolorem aliquid placeat quae amet laborum eveniet consequuntur quasi unde.
              </p>
                ...
                <AnimatePresence mode="wait">
                  {courses.map((course, index) => (
                    <motion.div
                      ...
                      className="relative flex-[0_0_85%] pl-4"
                    >
